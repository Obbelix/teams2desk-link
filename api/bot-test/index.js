module.exports = async function (context, req) {
    ...
    if (req.method === "GET") {
        context.res = {
            status: 200,
            body: "Bot test endpoint is ready! Send POST with message text to test bot logic.",
    ...
    try {
        ...
        console.log(`🧪 Test bot received message: "${messageText}"`);
        
        // Simulate the same bot logic as in the real bot
        let response = "";
        ...
        if (messageText.toLowerCase() === "hi" || messageText.toLowerCase() === "hello") {
            ...
            response = `I received your message: "${messageText}". I'm a test version of the Teams2Desk-Link bot. Try saying "hi", "help", or ask about creating cases!`;
        }
        ...
        context.res = {
            ...
            body: {
                success: true,
                message: "Bot logic executed successfully",
